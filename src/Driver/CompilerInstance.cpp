...
bool CompilerInstance::compile(const std::string &outputPath) {
    ...
    if (!target.isWasm()) {
        ...
        // Check if std::ui is imported — link UI runtime + wxWidgets
        bool needsUI = false;
        ...
        if (needsUI) {
            ...
            // Read wxWidgets lib paths from wx_libs.cfg (generated by CMake)
            std::string wxCfgCandidates[] = {
                exeDir + "/lib/wx_libs.cfg",
                exeDir + "/../lib/wx_libs.cfg",
            };
            for (auto &cfg : wxCfgCandidates) {
            ...
            flags.push_back("-lgdiplus");
            flags.push_back("-luser32");
            flags.push_back("-lshell32");
            flags.push_back("-lkernel32");
            flags.push_back("-lcomctl32");
            flags.push_back("-lrpcrt4");
            flags.push_back("-lole32");
            flags.push_back("-loleaut32");
            flags.push_back("-luuid");
            flags.push_back("-ladvapi32");
            flags.push_back("-lcomdlg32");
            flags.push_back("-lwinspool");
            flags.push_back("-lwinmm");
            flags.push_back("-lmsimg32");
            flags.push_back("-lshlwapi");
            flags.push_back("-lversion");
            flags.push_back("-lws2_32");
            flags.push_back("-lwininet");
            flags.push_back("-loleacc");
            flags.push_back("-luxtheme");
#endif
        }
